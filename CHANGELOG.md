...
- **`lissy93/dashy:4.7.8` moved to `lissy93/dashy:4.7.10`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.

## [2.4.7] - 2026-09-25

### Changed

- **`lissy93/dashy:4.7.7` moved to `lissy93/dashy:4.7.8`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
- **`lissy93/dashy:4.7.4` moved to `lissy93/dashy:4.7.5`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.

## [2.4.4] - 2026-09-21

### Changed

- **`lissy93/dashy:4.7.3` moved to `lissy93/dashy:4.7.4`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.

## [2.4.3] - 2026-09-21

### Changed

- **`lissy93/dashy:4.6.14` moved to `lissy93/dashy:4.7.3`.** The freshness check reported the lag; the deploy job booted the stack on the new image before this landed.
...
[Unreleased]: https://github.com/heyvaldemar/dashy-traefik-letsencrypt-docker-compose/compare/v2.5.0...HEAD
[2.5.0]: https://github.com/heyvaldemar/dashy-traefik-letsencrypt-docker-compose/compare/v2.4.8...v2.5.0
[2.4.5]: https://github.com/heyvaldemar/dashy-traefik-letsencrypt-docker-compose/compare/v2.4.4...v2.4.5
[2.4.4]: https://github.com/heyvaldemar/dashy-traefik-letsencrypt-docker-compose/compare/v2.4.3...v2.4.4
[2.4.3]: https://github.com/heyvaldemar/dashy-traefik-letsencrypt-docker-compose/compare/v2.4.2...v2.4.3
